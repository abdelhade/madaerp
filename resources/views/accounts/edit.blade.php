                    ...
                    <div class="card card-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control font-bold frst" type="text" name="aname" value="{{ $account->aname }}" id="frst">
                                        <div id="resaname"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control font-bold" name="is_basic" id="is_basic">
                                            <option value="1" {{ $account->is_basic == 1 ? 'selected' : '' }}>اساسي</option>
                                            <option value="0" {{ $account->is_basic == 0 ? 'selected' : '' }}>حساب عادي</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control font-bold" type="text" name="address" id="address" value="{{ $account->address }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="is_stock" id="is_stock" {{ $account->is_stock ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="secret">حساب سري</label>
                                                <input type="checkbox" name="secret" id="secret" {{ $account->secret ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="is_fund" id="is_fund" {{ $account->is_fund ? 'checked' : '' }}>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="rentable" id="rentable" {{ $account->rentable ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="employees_expensses"
                                                    id="employees_expensses" {{ $account->employees_expensses ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                        @endif
                        </div>
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{ route('accounts.index') }}" class="btn btn-secondary btn-block">رجوع</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        $('#frst').on('keyup', function() {
            ...
            $.ajax({
                ...
                error: function() {
                    $('#resaname').html("<p class='text-danger'>خطأ في التحقق من الاسم</p>");
                }
            });
        });
    });
