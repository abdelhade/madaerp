        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-3">
                        <input type="number" step="0.01" wire:model="discount_value" wire:change="calculateTotals"
                ...
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-3">
                        <input type="number" step="0.01" wire:model="additional_value" wire:change="calculateTotals"
                            class="form-control form-control-sm"
                            style="font-size: 0.95em; height: 2em; padding: 2px 6px;" min="0"
                            id="additional_value">
                    </div>
