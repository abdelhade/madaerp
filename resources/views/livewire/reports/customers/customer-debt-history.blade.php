...
<div>
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">تقرير أعمار ديون العملاء</h4>
        </div>
                ...
                <table class="table table-striped table-centered mb-0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="text-white">من يوم إلى 15 يوم (متاح للتحصيل)</th>
                            <th class="text-white">من 16 يوم إلى 30 يوم (متاح للتحصيل)</th>
                            <th class="text-white">من 31 يوم إلى 60 يوم (متاح للتحصيل)</th>
                            <th class="text-white">من 61 يوم إلى 90 يوم (متاح للتحصيل)</th>
                            <th class="text-white">من 91 يوم إلى 120 يوم (متاح للتحصيل)</th>
