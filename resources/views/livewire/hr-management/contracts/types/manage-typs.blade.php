...
<div class="container" style="direction: rtl; font-family: 'Cairo', sans-serif;">
    ...
    <div class="mb-3 col-md-4">
        <input type="text" class="form-control" style="font-family: 'Cairo', sans-serif;" placeholder="{{ __('Search by name...') }}" wire:model.live="search">
    </div>
            ...
            @forelse ($contractTypes as $type)
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-md btn-danger" wire:click="delete({{ $type->id }})" wire:confirm="{{ __('Are you sure you want to delete this contract type?') }}">
