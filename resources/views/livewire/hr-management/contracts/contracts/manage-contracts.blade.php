...
new class extends Component {
    ...
    public function edit($id)
    {
        ...
        if (empty($this->contractPoints)) $this->addContractPointInput();
        if (empty($this->salaryPoints)) $this->addSalaryPointInput();
...
<div style="font-family: 'Cairo', sans-serif; direction: rtl;">
    <div class="d-flex justify-content-between align-items-center mb-3 mt-3">
        ...
        <input type="text" class="form-control w-25" placeholder="{{ __('Search by name or employee...') }}" wire:model.live.debounce.300ms="search">
    </div>
            ...
            <tbody>
                @forelse ($contracts as $contract)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-md btn-info font-family-cairo fw-bold" wire:click="view({{ $contract->id }})"><i class="las la-eye font-18"></i></button>
                            <button class="btn btn-md btn-warning font-family-cairo fw-bold" wire:click="edit({{ $contract->id }})"><i class="las la-edit font-18"></i></button>
                            <button class="btn btn-md btn-danger font-family-cairo fw-bold" wire:click="delete({{ $contract->id }})" wire:confirm="{{ __('Are you sure?') }}"><i class="las la-trash font-18"></i></button>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="12" class="font-family-cairo fw-bold font-18 text-center">{{ __('No contracts found.') }}</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="save">
                        ...
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            <input type="text" class="form-control font-family-cairo fw-bold font-18" wire:model="name" required>
                                            @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <label class="form-label">{{ __('Contract Type') }}</label>
                                            <select class="form-select font-family-cairo fw-bold font-18" wire:model="contract_type_id" required style="height: 50px;">
                                                <option class="font-family-cairo fw-bold" value="">{{ __('Select...') }}</option>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            <select class="form-select font-family-cairo fw-bold font-18" wire:model="employee_id" required style="height: 50px;">
                                                <option class="font-family-cairo fw-bold font-14" value="">{{ __('Select...') }}</option>
                                                @foreach($employees as $employee)
                                                <option class="font-family-cairo fw-bold font-14" value="{{ $employee->id }}">{{ $employee->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            <select class="form-select font-family-cairo fw-bold font-18" wire:model="job_id" required style="height: 50px;">
                                                <option class="font-family-cairo fw-bold font-14" value="">{{ __('Select...') }}</option>
                                                @foreach($jobs as $job)
                                                <option class="font-family-cairo fw-bold font-14" value="{{ $job->id }}">{{ $job->title }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            <input type="date" class="form-control font-family-cairo fw-bold font-18" wire:model="contract_start_date" required>
                                            @error('contract_start_date') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <label class="form-label">{{ __('End Date') }}</label>
                                            <input type="date" class="form-control font-family-cairo fw-bold font-18" wire:model="contract_end_date" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" wire:model="fixed_work_hours">
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="las la-business-time"></i></span>
                                                <input type="number" step="0.01" class="form-control" wire:model="additional_work_hours">
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" wire:model="monthly_holidays">
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" wire:model="monthly_sick_days">
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="las la-info-circle"></i></span>
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-md btn-primary font-family-cairo fw-bold 18" wire:click="addContractPointInput">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr wire:key="contract-point-{{ $index }}">
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm" wire:model="contractPoints.{{ $index }}.sequence" required>
                                                        @error('contractPoints.'.$index.'.sequence') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm" wire:model="contractPoints.{{ $index }}.name" required>
                                                        @error('contractPoints.'.$index.'.name') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control form-control-sm" wire:model="contractPoints.{{ $index }}.information" rows="1"></textarea>
                                                        @error('contractPoints.'.$index.'.information') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-md btn-danger" wire:click="removeContractPointInput({{ $index }})">
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="4" class="text-center">{{ __('No contract points added yet.') }}</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-md btn-primary font-family-cairo fw-bold 18" wire:click="addSalaryPointInput">
                                        <i class="las la-plus font-18"></i> {{ __('Add Point') }}
                                    </button>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr wire:key="salary-point-{{ $index }}">
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm" wire:model="salaryPoints.{{ $index }}.sequence" required>
                                                        @error('salaryPoints.'.$index.'.sequence') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm" wire:model="salaryPoints.{{ $index }}.name" required>
                                                        @error('salaryPoints.'.$index.'.name') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control form-control-sm" wire:model="salaryPoints.{{ $index }}.information" rows="1"></textarea>
                                                        @error('salaryPoints.'.$index.'.information') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-md btn-danger" wire:click="removeSalaryPointInput({{ $index }})">
                                                            <i class="las la-trash font-18"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="12" class="text-center font-family-cairo fw-bold font-14">{{ __('No salary points added yet.') }}</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        <button type="button" class="btn btn-secondary font-family-cairo fw-bold font-14" wire:click="$set('showModal', false)">
    ...
    <div class="modal fade @if($showViewModal) show d-block @endif" tabindex="-1" style="background: rgba(0,0,0,0.5);">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-file-contract text-primary"></i> {{ __('Contract Name') }}:</span>
                                                <span>{{ $viewContract->name }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-user text-primary"></i> {{ __('Employee') }}:</span>
                                                <span>{{ $viewContract->employee?->name }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-tag text-primary"></i> {{ __('Contract Type') }}:</span>
                                                <span>{{ $viewContract->contract_type?->name }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-briefcase text-primary"></i> {{ __('Job') }}:</span>
                                                <span>{{ $viewContract->job?->title }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-calendar-plus text-primary"></i> {{ __('Start Date') }}:</span>
                                                <span>{{ $viewContract->contract_start_date }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-calendar-minus text-primary"></i> {{ __('End Date') }}:</span>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-clock text-primary"></i> {{ __('Fixed Work Hours') }}:</span>
                                                <span>{{ $viewContract->fixed_work_hours }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-business-time text-primary"></i> {{ __('Additional Work Hours') }}:</span>
                                                <span>{{ $viewContract->additional_work_hours }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-calendar text-primary"></i> {{ __('Monthly Holidays') }}:</span>
                                                <span>{{ $viewContract->monthly_holidays }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3 mb-3">
                                            <div class="d-flex">
                                                <span class="fw-bold me-2"><i class="las la-medkit text-primary"></i> {{ __('Monthly Sick Days') }}:</span>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-2">
                                                <span class="fw-bold"><i class="las la-info-circle text-primary"></i> {{ __('Information') }}:</span>
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-2">
                                                <span class="fw-bold"><i class="las la-briefcase text-primary"></i> {{ __('Job Description') }}:</span>
                                            </div>
                                            <div class="border rounded p-2 bg-light">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            <thead class="table-light">
                                                <tr>
                                                    <th width="10%" class="font-family-cairo fw-bold font-14">{{ __('Sequence') }}</th>
                                                    <th width="30%" class="font-family-cairo fw-bold font-14">{{ __('Point Name') }}</th>
                                                    <th width="60%" class="font-family-cairo fw-bold font-14">{{ __('Information') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse ($viewContract->contract_points as $point)
                                                <tr>
                                                    <td class="text-center font-family-cairo fw-bold font-14">{{ $point->sequence }}</td>
                                                    <td class="font-family-cairo fw-bold font-14">{{ $point->name }}</td>
                                                    <td class="font-family-cairo fw-bold font-14">{{ $point->information ?: __('No information provided.') }}</td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="3" class="text-center">{{ __('No contract points found.') }}</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="3" class="text-center font-family-cairo fw-bold font-18">{{ __('No salary points found.') }}</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn btn-secondary font-family-cairo fw-bold font-14" wire:click="$set('showViewModal', false)">
