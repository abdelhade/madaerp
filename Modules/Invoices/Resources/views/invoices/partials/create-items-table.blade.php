...
@php
    ...
    $template = $createData['selected_template'] ?? null;
    ...
    $columnMapping = [
        'discount' => 'disc_value', // In the template 'discount' maps to discount value
    ];
@endphp
                                ...
                                @switch($col)
                                    @case('item_name')
                                        @include('invoices::components.item-search-input', [
                                            ...
                                            'invoiceType' => $type,
                                            'branchId' => $createData['branch_id'] ?? null,
                                            'priceType' => 1,
...
(function() {
    ...
    // Get all navigable inputs in a row
    function getRowInputs(row) {
        return Array.from(row.querySelectorAll('input:not([readonly]):not([disabled]), select:not([disabled])'));
    }
    ...
    table.addEventListener('keydown', function(e) {
        ...
        // RTL layout - swap left/right behavior
