                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-4">
                                ...
                                <select class="form-select" id="preferred_contact_method" name="preferred_contact_method">
                                    <option value="phone" {{ old('preferred_contact_method') == 'phone' ? 'selected' : '' }}>{{ __('Phone') }}</option>
                                    <option value="whatsapp" {{ old('preferred_contact_method') == 'whatsapp' ? 'selected' : '' }}>{{ __('WhatsApp') }}</option>
                                    <option value="email" {{ old('preferred_contact_method') == 'email' ? 'selected' : '' }}>{{ __('Email') }}</option>
                                </select>
